"""Script companion for notebook 11: deep MNIST superposition activations.

This file mirrors the notebook 11 flow in a runnable Python module:
...
5. Train three deep quantum-activation classifier variants with hidden_layers=(6, 6):
   - standard
   - mode_a
   - mode_b
6. Plot diagnostics and print a final comparison table.

Unlike notebook 10, this version stacks learned superposition activations across
two hidden layers. The old fixed tanh squash is removed from the classifier
path, so every hidden nonlinearity is learned from a superposition profile.
"""
...
def main() -> None:
    ...
    print("# Deep MNIST Classification With Learned Superposition Activations")
    print()
    ...
    print()
    print("## Deep Quantum Activation Models")
