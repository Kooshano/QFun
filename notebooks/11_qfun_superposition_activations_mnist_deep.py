...
# mirrors **Note10**: full MNIST, PCA features, JAX training when available, and run artifacts
...
OUTPUT_ROOT = Path(__file__).resolve().parent / "note11_outputs" / RUN_ID
...
_save_json(
    ...
    {
        "script": "11_qfun_superposition_activations_mnist_deep",
        "data_seed": data_seed,
        "test_size": test_size,
