# Notebook 11 Architecture: Deep MNIST With Learned Superposition Activations

## Purpose

`11_qfun_superposition_activations_mnist_deep.ipynb` is the deep follow-up to notebook 10.
