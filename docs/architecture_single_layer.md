# Single-Layer MNIST Architecture: Learned Superposition Activations

## Purpose

`experiments/run_mnist_single_layer.py` is the canonical MNIST-scale benchmark for the repository's learned superposition activation idea.
...
| File | Role |
| --- | --- |
| `experiments/run_mnist_single_layer.py` | User-facing experiment driver |
