# Quantum-KAN MNIST Ablation Architecture

## Purpose

`experiments/run_mnist_deep.py` is the pure deep-superposition
reference.

`experiments/run_mnist_kan_ablation.py` adds a new ablation family that moves
