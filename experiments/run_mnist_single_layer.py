...
#
# All figures, console output, and numeric summaries are written under
# ``notebooks/note10_outputs/<run_id>/``.
...
OUTPUT_ROOT = PROJECT_ROOT / "notebooks" / "note10_outputs" / RUN_ID
